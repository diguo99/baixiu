<?php
    ...
    $sql='SELECT p.title,p.feature,p.created,p.content,p.likes,p.views,c.`name`,u.nickname,(SELECT (COUNT(id)) FROM comments c WHERE post_id=c.id) AS commentsCount FROM posts p
